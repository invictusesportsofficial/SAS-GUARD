  ...
  function _buildPasswordOverlay(tok, tokenExpiry) {
    ...
    pw_overlay.innerHTML = [
      ...
      '<div id="__sas_pw_box__">',
        ...
        '<div style="color:#e2e8f0;font-size:20px;font-weight:700;margin-bottom:6px">Password Required</div>',
        '<div style="color:#94a3b8;font-size:13px">This site requires an additional password.</div>',
        '<div id="__sas_pw_card__">',
          '<label style="display:block;font-size:11px;color:#94a3b8;letter-spacing:1px;',
            'font-family:monospace;margin-bottom:6px">SITE PASSWORD</label>',
